...
@section('content')
    <section class="articl1">
        ...
        <div class="p2">
            <img src="{{ asset('images/Purple & Yellow Minimal School Admission Facebook Post (1).jpg') }}"
